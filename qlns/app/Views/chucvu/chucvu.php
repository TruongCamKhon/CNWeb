        ...
        while($item = $stmt-> fetch(PDO::FETCH_ASSOC)) {
            echo
                "<tr>
                    ...
                    <td><a class='btn btn-danger' href='http://localhost/qlns/app/Views/chucvu/editChucvu.php/?macv=" . $item['maCV'] . "&id=" . $item['id'] . "&per_page=" . $per_page . "&current_page=" . $current_page . "'>Edit</a>
                        <a class='btn btn-danger' href='http://localhost/qlns/app/Views/chucvu/deleteChucvu.php/?macv=" . $item['maCV'] . "&id=" . $item['id'] . "&per_page=" . $per_page . "&current_page=" . $current_page . "'>Delete</a>
                    </td>
                </tr>";
        }
        $conn = null;
